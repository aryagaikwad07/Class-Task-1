...
// creating boat animation
  ...
  // creating broken boat animation 
...
// playing background music and setting volume 
 ...
 // showing and loading cannon balls, checking for collision and removing used cannon ball
...
function showBoats() {
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      boats[i].display();
      boats[i].animate();
      // checking for collision and if boat is not broken 
...
// creating a pop up box when game ends 
function gameOver() {
  swal(
    {
      title: `Game Over!!!`,
